      ...
      <main class="flex-1 overflow-auto bg-gray-50 dark:bg-gray-900 transition-colors duration-200">
        <div class="container mx-auto px-4 py-8">
          <div class="max-w-4xl mx-auto">
            ...
            <div class="sticky top-0 z-10 bg-gray-50 dark:bg-gray-800 pt-4 pb-2 transition-colors duration-200">
              <SearchSection 
            ...
            <div class="mt-4">
              ...
              <div v-if="!isLoading && results.length === 0" class="mt-8">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 text-center transition-colors duration-200">
