...
<template>
  <div class="border border-gray-200 dark:border-gray-700 rounded-lg overflow-hidden shadow-sm bg-white dark:bg-gray-800 transition-colors duration-200">
    <!-- Card Header -->
    <div 
      @click="toggleExpand" 
    ...
    >
      <div class="flex-grow">
        <h3 class="text-lg font-semibold text-blue-600 dark:text-blue-400 flex items-center">
          ...
          <span class="ml-2 text-xs bg-blue-100 dark:bg-blue-900 text-blue-800 dark:text-blue-300 px-2 py-1 rounded">
    ...
    <div 
      v-if="isExpanded" 
      class="p-4 bg-gray-50 dark:bg-gray-700 border-t border-gray-200 dark:border-gray-600 space-y-6 transition-colors duration-200"
    >
      <!-- Funding Amount -->
      <div>
