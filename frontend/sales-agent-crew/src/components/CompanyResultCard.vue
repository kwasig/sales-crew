...
<template>
  <div class="border border-gray-200 dark:border-dark-600 rounded-lg overflow-hidden shadow-sm bg-white dark:bg-dark-800">
    <!-- Card Header -->
    <div 
      @click="toggleExpand" 
    ...
    >
      ...
      <div class="relative">
        ...
        <button 
          @click="copyEmailBody"
          class="absolute top-0 right-0 text-gray-500 hover:text-blue-600 dark:text-gray-400 dark:hover:text-blue-400 transition"
