<template>
  <div class="bg-white dark:bg-gray-800 rounded-xl shadow-md border border-gray-100 dark:border-gray-700 p-6">
    ...
    <div class="flex items-center space-x-4">
      <div class="relative flex-1">
        <input
          ...
          class="block w-full pl-5 pr-12 py-4 text-base rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200"
    ...
    <!-- Recording Status -->
    <div v-if="isRecording" class="mt-2 text-sm text-gray-600 dark:text-gray-300 flex items-center space-x-2">
