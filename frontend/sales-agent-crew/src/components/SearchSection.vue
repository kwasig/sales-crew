<template>
  <div class="bg-white dark:bg-dark-800 rounded-xl shadow-md border border-gray-100 dark:border-dark-700 p-6">
    <!-- Warning Message -->
    <div v-if="missingKeys.length > 0" class="mb-4 p-4 rounded-lg bg-yellow-50 dark:bg-yellow-900 border border-yellow-200 dark:border-yellow-700">
      <div class="flex">
        ...
        <div>
          <p class="font-medium text-yellow-800 dark:text-yellow-200">
            ...
            <button
              ...
              class="underline text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300"
            >
              settings
            </button>.
          </p>
    ...
    <div class="flex items-center space-x-4">
      <div class="relative flex-1">
        <input
          ...
          class="block w-full pl-5 pr-12 py-4 text-base rounded-lg border border-gray-300 dark:border-dark-600 bg-gray-50 dark:bg-dark-700 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all duration-200"
        ...
        <button
          ...
          class="absolute right-4 top-1/2 transform -translate-y-1/2 p-2 hover:bg-gray-100 dark:hover:bg-dark-600 rounded-full transition-colors"
          title="Voice Search"
        >
          <svg 
    ...
    <!-- Recording Status -->
    <div v-if="isRecording" class="mt-2 text-sm text-gray-600 dark:text-gray-400 flex items-center space-x-2">
