<template>
  <header class="shadow-md bg-white dark:bg-gray-800 transition-colors duration-200">
    <div class="h-16 mx-auto px-4 sm:px-6 flex items-center justify-between">
      ...
      <div class="flex items-center space-x-2 sm:space-x-4">
        ...
        <h1 class="text-lg sm:text-2xl font-bold text-gray-900 dark:text-white tracking-tight">
