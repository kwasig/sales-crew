<template>
  <div v-if="isOpen" class="fixed inset-0 z-50 overflow-y-auto">
    <div class="flex min-h-screen items-center justify-center p-4">
      ...
      <!-- Modal -->
      <div class="relative w-full max-w-lg bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 transition-colors duration-200">
        ...
        <!-- Success Message -->
        <div v-if="successMessage" class="mb-4 p-3 bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300 rounded">
          {{ successMessage }}
        </div>
          ...
          <div>
            ...
            <div class="relative">
              <input
                ...
                class="block w-full border border-gray-300 dark:border-gray-600 rounded-md shadow-sm p-2 focus:outline-none focus:ring-primary-500 focus:border-primary-500 pr-10 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
              />
              <button 
